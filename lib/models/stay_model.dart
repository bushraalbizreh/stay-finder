...
class StayModel  {
  ...
  factory StayModel.fromMap(Map<String, dynamic> json) => StayModel(
    ...
    availableRooms: json["available_rooms"] == null
        ? []
        : List<AvailableRoom>.from(
            json["available_rooms"]!.map((x) => AvailableRoom.fromMap(x)),
          ),
  ...
  Map<String, dynamic> toMap() => {
    ...
    "available_rooms": availableRooms == null
        ? []
        : List<dynamic>.from(availableRooms!.map((x) => x.toMap())),
